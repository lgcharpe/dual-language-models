...
from dual_language_models.optimizers.normuon import NorMuonWithAuxAdam as NorMuon
...
def parse_arguments():
    ...
    parser.add_argument("--optimizer", default="muon", type=str, choices=["muon", "normuon", "adamw", "muonh", "muonh_vr"])
